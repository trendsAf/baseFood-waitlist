	...
	return (
		<div className="bg-white w-full fixed z-50 top-0 shadow">
			<div className="flex justify-between items-center lg:max-w-[80%] max-w-[90%] mx-auto py-4 ">
				<div className="heading-font text-[#2245fe] font-bold text-3xl">
					baseFood
				</div>
				<div>
					<button
						className="bg-[#2245fe] hover:bg-gradient-to-r hover:from-[#2245FE] hover:to-blue-700 text-white heading-font px-4 text-xs lg:text-lg py-2 rounded-[8px]"
